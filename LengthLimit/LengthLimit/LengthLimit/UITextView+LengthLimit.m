...
//光标的赋值
- (void) setSelectedTextViewRange:(NSRange) range  // 备注：UITextField必须为第一响应者才有效
{
...
{
    self.textRang = [self selectedRangeTextView];
    ...
    [self setSelectedTextViewRange:self.textRang];
}
